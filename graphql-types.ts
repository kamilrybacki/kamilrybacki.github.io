...
export type MdxFrontmatterFilterInput = {
  ...
  readme?: InputMaybe<StringQueryOperatorInput>;
};
...
export type FileFieldsEnum =
  ...
  | 'childrenMdx___frontmatter___techs'
  | 'childrenMdx___frontmatter___abstract'
  | 'childrenMdx___frontmatter___link'
  | 'childrenMdx___frontmatter___readme'
  | 'childrenMdx___slug'
  | 'childrenMdx___body'
...
export type AssetsPhotosQueryVariables = Exact<{ [key: string]: never; }>;
...
export type TechImagesQuery = { allFile: { edges: Array<{ node: { name: string, publicURL?: string | null } }> } };

export type PostsThumbnailsQueryVariables = Exact<{ [key: string]: never; }>;


export type PostsThumbnailsQuery = { allFile: { edges: Array<{ node: { publicURL?: string | null } }> } };

export type ProjectsThumbnailsQueryVariables = Exact<{ [key: string]: never; }>;


export type ProjectsThumbnailsQuery = { allFile: { edges: Array<{ node: { absolutePath: string, publicURL?: string | null } }> } };
...
export type ProjectsQuery = { allMdx: { nodes: Array<{ id: string, excerpt: string, slug?: string | null, frontmatter?: { title: string, date?: any | null, thumbnail?: string | null, gallery?: string | null, techs?: string | null, abstract?: string | null } | null }> } };
