...
Now it is obvious why changing the $\sigma$ parameter scaled our graphs vertically - **it is the depth of the potential well itself!$$.
Even the minus doubles down on this fact since, as we saw on the plots, the minimum of energy is always below zero.
...
So, since we used Jupter Notebook to visualize the Lennard-Jones potential and force, we can also use it to
