...
<CodeSnippet
  ...
  `}
  annotations='
    2:Beginning of the GraphQL query
    4:Selecting all the markdown files from the `projects` directory
    10:Querying the frontmatter data
    ...
    6-12:src/pages/projects/coolProject
  '
/>
