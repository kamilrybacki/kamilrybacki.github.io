...
<figcaption>The live feed on the bus: events arrive over <code>braid.ingest</code>, each with its own shape (note <code>origin_id</code>), and fan out to agent lanes as they are routed.</figcaption>
</figure>
